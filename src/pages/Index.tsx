...
import { ArrowRight, FlaskConical, Factory, Package, Beaker } from "lucide-react";
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center">
        <div className="absolute inset-0">
          <img src={heroBg} alt="NuEra Manufacturing Facility" className="w-full h-full object-cover" />
          <div className="absolute inset-0 hero-gradient opacity-85" />
        </div>
        <div className="container relative z-10 py-20 md:py-32">
          <div className="max-w-3xl">
            <p className="text-secondary font-sans font-semibold text-sm uppercase tracking-widest mb-4">Since 2007</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-primary-foreground mb-4 leading-tight">
              GMP-Certified Nutraceutical Manufacturing Partner
            </h1>
            <p className="text-lg text-primary-foreground/90 font-sans mb-2 font-medium">
              Speed • Compliance • Scalable Production
            </p>
            <p className="text-base text-primary-foreground/80 font-sans mb-8 max-w-2xl leading-relaxed">
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={card.title} className="bg-card border border-border rounded-lg p-8 hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "High-Speed Encapsulation",
                body: "5 high-speed encapsulation lines engineered for consistency, throughput, and repeatable quality.",
                img: capsulesImg,
              },
              {
              ...
              <div key={card.title} className="group relative overflow-hidden rounded-lg border border-border">
                <div className="h-48 overflow-hidden">
                  <img src={card.img} alt={card.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="text-lg font-serif font-bold text-foreground mb-2">{card.title}</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">{card.body}</p>
                </div>
              </div>
            ))}
          ...
          <div className="mt-10 text-center">
            <Button asChild size="lg">
              <Link to="/services">Explore Our Capabilities <ArrowRight size={16} /></Link>
            </Button>
          </div>
        </div>
      </section>

      {/* SECTION 4 – ABOUT SPLIT BLOCK */}
      <section className="py-16 md:py-24 section-light">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-6">Built on Trust Since 2007</h2>
      ...
      {/* SECTION 5 – PIPELINE SPLIT BLOCK */}
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-6">From Concept to Commercialization</h2>
              <p className="text-muted-foreground leading-relaxed mb-8">
            ...
            <div>
              <img src={packagingImg} alt="Manufacturing Pipeline" className="rounded-lg shadow-lg w-full" />
            </div>
          </div>
        </div>
      </section>

      {/* SECTION 6 – REGULATORY & COMPLIANCE SPLIT BLOCK */}
      <section className="py-16 md:py-24 section-light">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img src={labImg} alt="Quality Control Laboratory" className="rounded-lg shadow-lg w-full" />
            </div>
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-6">Regulatory & Compliance Leadership</h2>
              <p className="text-muted-foreground leading-relaxed mb-8">
      ...
      {/* SECTION 9 – RELATED LINKS GRID */}
      <section className="py-16 md:py-24 section-light">
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Our Services", desc: "Explore our turnkey manufacturing, formulation, and packaging capabilities.", path: "/services", img: capsulesImg },
              { title: "About Us", desc: "Learn about our history, facility, and commitment to quality since 2007.", path: "/about", img: facilityImg },
              { title: "Contact Us", desc: "Get in touch for quotes, consultations, or to submit your product formula.", path: "/contact", img: packagingImg },
            ].map((card) => (
              <Link to={card.path} key={card.title} className="group block overflow-hidden rounded-lg border border-border bg-card hover:shadow-lg transition-shadow">
                <div className="h-48 overflow-hidden">
                  <img src={card.img} alt={card.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="p-6">
